        ...
        <>
          <div className="flex justify-between mx-20 bg-transparent gap-x-20">
            <div className="w-1/3 p-6 justify-items-center items-center bg-transparent text-white gap-y-3 grid">
              <img src={song.album.images[0].url} alt="" className="w-full" />
              <h1 className="text-3xl font-bold">{ song.name }</h1>
              <p>Music Maven</p>
              <p className="text-slate-300 font-semibold">{song.album.artists[0].type}<i className="fa-solid fa-circle mx-2 text-[4px]"></i>{ song.album.artists[0].name }</p>
