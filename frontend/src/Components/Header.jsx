...
function Header() {
  ...
  const handleScroll = () => {
    ...
    if (window.scrollY > 0) {
      header.classList.add("bg-gradient-to-r", "from-customColor1", "to-customColor2");
      header.classList.remove("bg-transparent");
    } else {
      header.classList.add("bg-transparent");
      header.classList.remove("bg-gradient-to-r", "from-customColor1", "to-customColor2");
    }
  }
  ...
  return (
    <>
      <Aside />
      <header className="flex fixed top-0 left-0 z-100 px-14 pl-1 w-full bg-transparent">
